...
Expired sessions are cleaned up automatically. Unexpired revoked sessions remain visible
for up to a day before cleanup; their audit records follow the audit retention policy.
