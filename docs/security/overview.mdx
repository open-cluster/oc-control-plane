...
and manage memberships, but cannot replace an existing User's password. Local password
changes and deployment recovery are not yet available through a supported operation.
