...
Open [http://localhost:8080](http://localhost:8080) and bootstrap the first Organization
and its Admin User. Follow the [Quickstart](/getting-started/quickstart) to
