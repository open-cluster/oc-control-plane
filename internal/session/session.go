...
// yields no usable credential, for the same reason the Connection secret table yields none.
//
// This package performs no I/O. internal/storage writes and reads the rows; what a session IS,
