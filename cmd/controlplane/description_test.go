...
func TestDescription_TheOperatorAPIBaseAnswersWhatThisDeploymentServes(t *testing.T) {
	...
	for _, wanted := range []string{
		"/operator/v1/organizations/{organization}/sign-in/providers",
		"/operator/v1/organizations/{organization}/sign-in/{provider}",
		"/operator/v1/sign-in/callback",
		"/operator/v1/organizations/{organization}/sign-in/saml/{provider}/callback",
	} {
		found := false
